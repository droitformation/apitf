<?php namespace App\Droit\Transfert\Content\Entities;
...
class Content extends Model {
    ...
    public function getNameAttribute()
    {
        ...
        if($this->content)
        {
            return strip_tags($this->truncate($this->content,80,'...',true));
        }
    }
    ...
    {
        return $this->belongsTo('App\Droit\Transfert\Page\Entities\Page');
    }
}